...
/**
 * Builds and executes requests for operations under /api/v1/watch/nodes
 */
export interface NodesRequestBuilder extends BaseRequestBuilder<NodesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.watch.nodes.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<NodesRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Node. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const NodesRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/nodes{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
