...
/**
 * Builds and executes requests for operations under /api/v1/watch/events
 */
 ...
 */
export const EventsRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/events{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
