...
/**
 * Builds and executes requests for operations under /api/v1/watch/serviceaccounts
 */
 ...
 */
export const ServiceaccountsRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/serviceaccounts{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
