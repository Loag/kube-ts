...
/**
 * Builds and executes requests for operations under /api/v1/watch/services
 */
 ...
 */
export const ServicesRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/services{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
