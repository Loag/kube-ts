...
/**
 * Builds and executes requests for operations under /api/v1/watch/endpoints
 */
 ...
 */
export const EndpointsRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/endpoints{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
