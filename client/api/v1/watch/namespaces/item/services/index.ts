...
/**
 * Builds and executes requests for operations under /api/v1/watch/namespaces/{namespace-id}/services
 */
export interface ServicesRequestBuilder extends BaseRequestBuilder<ServicesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.watch.namespaces.item.services.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ServicesRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Service. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ServicesRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/namespaces/{namespace%2Did}/services{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
