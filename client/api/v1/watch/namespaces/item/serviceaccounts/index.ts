...
/**
 * Builds and executes requests for operations under /api/v1/watch/namespaces/{namespace-id}/serviceaccounts
 */
export interface ServiceaccountsRequestBuilder extends BaseRequestBuilder<ServiceaccountsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.watch.namespaces.item.serviceaccounts.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ServiceaccountsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of ServiceAccount. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ServiceaccountsRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/namespaces/{namespace%2Did}/serviceaccounts{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
