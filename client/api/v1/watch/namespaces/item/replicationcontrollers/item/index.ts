...
/**
 * Builds and executes requests for operations under /api/v1/watch/namespaces/{namespace-id}/replicationcontrollers/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/namespaces/{namespace%2Did}/replicationcontrollers/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
