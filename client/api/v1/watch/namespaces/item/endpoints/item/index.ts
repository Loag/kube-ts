...
/**
 * Builds and executes requests for operations under /api/v1/watch/namespaces/{namespace-id}/endpoints/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/namespaces/{namespace%2Did}/endpoints/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
