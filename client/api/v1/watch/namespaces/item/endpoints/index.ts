...
/**
 * Builds and executes requests for operations under /api/v1/watch/namespaces/{namespace-id}/endpoints
 */
export interface EndpointsRequestBuilder extends BaseRequestBuilder<EndpointsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.watch.namespaces.item.endpoints.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<EndpointsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Endpoints. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const EndpointsRequestBuilderUriTemplate = "{+baseurl}/api/v1/watch/namespaces/{namespace%2Did}/endpoints{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
