...
/**
 * Builds and executes requests for operations under /api/v1/persistentvolumes/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<PersistentVolume | undefined>;
    /**
     ...
     * @returns {Promise<PersistentVolume>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<PersistentVolume | undefined>;
    /**
     ...
     * @returns {Promise<PersistentVolume>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<PersistentVolume | undefined>;
    /**
     * read status of the specified PersistentVolume
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/api/v1/persistentvolumes/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
