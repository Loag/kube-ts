...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/resourcequotas/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<ResourceQuota | undefined>;
    /**
     ...
     * @returns {Promise<ResourceQuota>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<ResourceQuota | undefined>;
    /**
     ...
     * @returns {Promise<ResourceQuota>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<ResourceQuota | undefined>;
    /**
     * read status of the specified ResourceQuota
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/api/v1/namespaces/{namespace%2Did}/resourcequotas/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
