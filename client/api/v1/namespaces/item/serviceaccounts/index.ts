...
// @ts-ignore
import { createServiceAccountFromDiscriminatorValue, createServiceAccountListFromDiscriminatorValue, type ServiceAccount, type ServiceAccountList } from '../../../../../models/api/core/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/serviceaccounts
 */
export interface ServiceaccountsRequestBuilder extends BaseRequestBuilder<ServiceaccountsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.namespaces.item.serviceaccounts.item collection
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<ServiceaccountsRequestBuilderDeleteQueryParameters> | undefined) : Promise<Status | undefined>;
    /**
     * list or watch objects of kind ServiceAccount
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<ServiceAccountList>}
     */
     get(requestConfiguration?: RequestConfiguration<ServiceaccountsRequestBuilderGetQueryParameters> | undefined) : Promise<ServiceAccountList | undefined>;
    /**
     ...
     */
     post(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<ServiceaccountsRequestBuilderPostQueryParameters> | undefined) : Promise<ServiceAccount | undefined>;
    /**
     * delete collection of ServiceAccount
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toDeleteRequestInformation(body: DeleteOptions, requestConfiguration?: RequestConfiguration<ServiceaccountsRequestBuilderDeleteQueryParameters> | undefined) : RequestInformation;
    /**
     * list or watch objects of kind ServiceAccount
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<ServiceaccountsRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * delete collection of ServiceAccount
 */
export interface ServiceaccountsRequestBuilderDeleteQueryParameters {
    /**
 ...
 * create a ServiceAccount
 */
export interface ServiceaccountsRequestBuilderPostQueryParameters {
    /**
     * When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     */
    dryRun?: string;
...
export const ServiceaccountsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createServiceAccountListFromDiscriminatorValue,
    },
    post: {
        uriTemplate: ServiceaccountsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        adapterMethodName: "send",
        responseBodyFactory:  createServiceAccountFromDiscriminatorValue,
