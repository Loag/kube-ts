...
// @ts-ignore
import { createPersistentVolumeClaimFromDiscriminatorValue, serializePersistentVolumeClaim, type PersistentVolumeClaim } from '../../../../../../models/api/core/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/persistentvolumeclaims/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderDeleteQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     * read the specified PersistentVolumeClaim
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<PersistentVolumeClaim>}
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     ...
     * @returns {Promise<PersistentVolumeClaim>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     ...
     * @returns {Promise<PersistentVolumeClaim>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     * delete a PersistentVolumeClaim
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/api/v1/namespaces/{namespace%2Did}/persistentvolumeclaims/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
