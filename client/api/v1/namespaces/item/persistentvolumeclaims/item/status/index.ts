...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/persistentvolumeclaims/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     ...
     * @returns {Promise<PersistentVolumeClaim>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     ...
     * @returns {Promise<PersistentVolumeClaim>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<PersistentVolumeClaim | undefined>;
    /**
     * read status of the specified PersistentVolumeClaim
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/api/v1/namespaces/{namespace%2Did}/persistentvolumeclaims/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
