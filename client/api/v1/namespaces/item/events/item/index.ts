...
// @ts-ignore
import { createEventFromDiscriminatorValue, serializeEvent, type Event } from '../../../../../../models/api/core/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/events/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/api/v1/namespaces/{namespace%2Did}/events/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
