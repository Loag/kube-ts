...
// @ts-ignore
import { createEventFromDiscriminatorValue, createEventListFromDiscriminatorValue, type Event, type EventList } from '../../../../../models/api/core/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/events
 */
export interface EventsRequestBuilder extends BaseRequestBuilder<EventsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.namespaces.item.events.item collection
