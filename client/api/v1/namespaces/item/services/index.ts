...
// @ts-ignore
import { createServiceFromDiscriminatorValue, createServiceListFromDiscriminatorValue, type Service, type ServiceList } from '../../../../../models/api/core/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/services
 */
export interface ServicesRequestBuilder extends BaseRequestBuilder<ServicesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.namespaces.item.services.item collection
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<ServicesRequestBuilderDeleteQueryParameters> | undefined) : Promise<Status | undefined>;
    /**
     * list or watch objects of kind Service
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<ServiceList>}
     */
     get(requestConfiguration?: RequestConfiguration<ServicesRequestBuilderGetQueryParameters> | undefined) : Promise<ServiceList | undefined>;
    /**
     * create a Service
     ...
     */
     post(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<ServicesRequestBuilderPostQueryParameters> | undefined) : Promise<Service | undefined>;
    /**
     * delete collection of Service
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toDeleteRequestInformation(body: DeleteOptions, requestConfiguration?: RequestConfiguration<ServicesRequestBuilderDeleteQueryParameters> | undefined) : RequestInformation;
    /**
     * list or watch objects of kind Service
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<ServicesRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * delete collection of Service
 */
export interface ServicesRequestBuilderDeleteQueryParameters {
    /**
 ...
 * create a Service
 */
export interface ServicesRequestBuilderPostQueryParameters {
    /**
     * When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     */
    dryRun?: string;
...
export const ServicesRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createServiceListFromDiscriminatorValue,
    },
    post: {
        uriTemplate: ServicesRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
