...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/services/{name}/proxy/{path}
 */
 ...
 */
export const WithPathItemRequestBuilderUriTemplate = "{+baseurl}/api/v1/namespaces/{namespace%2Did}/services/{name}/proxy/{path}{?path*}";
/**
