...
/**
 * Builds and executes requests for operations under /api/v1/namespaces/{namespace-id}/replicationcontrollers/{name}/scale
 */
 ...
 */
export const ScaleRequestBuilderUriTemplate = "{+baseurl}/api/v1/namespaces/{namespace%2Did}/replicationcontrollers/{name}/scale{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
