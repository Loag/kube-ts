...
// @ts-ignore
import { createServiceListFromDiscriminatorValue, type ServiceList } from '../../../models/api/core/v1/index.js';
// @ts-ignore
 ...
 */
export const ServicesRequestBuilderUriTemplate = "{+baseurl}/api/v1/services{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
