...
/**
 * Builds and executes requests for operations under /api/v1/nodes/{name}/proxy/{path}
 */
 ...
 */
export const WithPathItemRequestBuilderUriTemplate = "{+baseurl}/api/v1/nodes/{name}/proxy/{path}{?path*}";
/**
