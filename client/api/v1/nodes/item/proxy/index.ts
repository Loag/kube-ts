...
/**
 * Builds and executes requests for operations under /api/v1/nodes/{name}/proxy
 */
export interface ProxyRequestBuilder extends BaseRequestBuilder<ProxyRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.v1.nodes.item.proxy.item collection
 ...
 */
export const ProxyRequestBuilderUriTemplate = "{+baseurl}/api/v1/nodes/{name}/proxy{?path*}";
/**
