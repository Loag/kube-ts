...
/**
 * Builds and executes requests for operations under /api/v1/nodes/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<Node | undefined>;
    /**
     ...
     * @returns {Promise<Node>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<Node | undefined>;
    /**
     ...
     * @returns {Promise<Node>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<Node | undefined>;
    /**
     * read status of the specified Node
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/api/v1/nodes/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
