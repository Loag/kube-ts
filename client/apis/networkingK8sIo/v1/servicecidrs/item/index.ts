...
// @ts-ignore
import { createServiceCIDRFromDiscriminatorValue, serializeServiceCIDR, type ServiceCIDR } from '../../../../../models/api/networking/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1/servicecidrs/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1/servicecidrs/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
