...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1/servicecidrs/{name}/status
 */
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1/servicecidrs/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
