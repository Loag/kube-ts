...
// @ts-ignore
import { createIPAddressFromDiscriminatorValue, serializeIPAddress, type IPAddress } from '../../../../../models/api/networking/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1/ipaddresses/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1/ipaddresses/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
