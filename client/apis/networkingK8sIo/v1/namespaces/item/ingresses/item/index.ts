...
// @ts-ignore
import { createIngressFromDiscriminatorValue, serializeIngress, type Ingress } from '../../../../../../../models/api/networking/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<Ingress | undefined>;
    /**
     ...
     * @returns {Promise<Ingress>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<Ingress | undefined>;
    /**
     ...
     * @returns {Promise<Ingress>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<Ingress | undefined>;
    /**
     * delete an Ingress
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
