...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<Ingress | undefined>;
    /**
     ...
     * @returns {Promise<Ingress>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<Ingress | undefined>;
    /**
     ...
     * @returns {Promise<Ingress>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<Ingress | undefined>;
    /**
     * read status of the specified Ingress
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
