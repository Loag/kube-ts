...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1beta1/
 */
 ...
 */
export const V1beta1RequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1beta1/";
/**
