...
// @ts-ignore
import { createIPAddressFromDiscriminatorValue, serializeIPAddress, type IPAddress } from '../../../../../models/api/networking/v1beta1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1beta1/ipaddresses/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<IPAddress | undefined>;
    /**
     ...
     * @returns {Promise<IPAddress>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<IPAddress | undefined>;
    /**
     ...
     * @returns {Promise<IPAddress>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<IPAddress | undefined>;
    /**
     * delete an IPAddress
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1beta1/ipaddresses/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
