...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1beta1/servicecidrs/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<ServiceCIDR | undefined>;
    /**
     ...
     * @returns {Promise<ServiceCIDR>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<ServiceCIDR | undefined>;
    /**
     ...
     * @returns {Promise<ServiceCIDR>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<ServiceCIDR | undefined>;
    /**
     * read status of the specified ServiceCIDR
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1beta1/servicecidrs/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
