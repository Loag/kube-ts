...
// @ts-ignore
import { createServiceCIDRFromDiscriminatorValue, serializeServiceCIDR, type ServiceCIDR } from '../../../../../models/api/networking/v1beta1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/networking.k8s.io/v1beta1/servicecidrs/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ServiceCIDR | undefined>;
    /**
     ...
     * @returns {Promise<ServiceCIDR>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ServiceCIDR | undefined>;
    /**
     ...
     * @returns {Promise<ServiceCIDR>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ServiceCIDR | undefined>;
    /**
     * delete a ServiceCIDR
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/networking.k8s.io/v1beta1/servicecidrs/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
