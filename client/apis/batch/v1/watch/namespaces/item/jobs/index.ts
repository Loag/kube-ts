...
/**
 * Builds and executes requests for operations under /apis/batch/v1/watch/namespaces/{namespace}/jobs
 */
export interface JobsRequestBuilder extends BaseRequestBuilder<JobsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.batch.v1.watch.namespaces.item.jobs.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<JobsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Job. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const JobsRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/watch/namespaces/{namespace}/jobs{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
