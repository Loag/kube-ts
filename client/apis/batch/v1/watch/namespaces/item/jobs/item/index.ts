...
/**
 * Builds and executes requests for operations under /apis/batch/v1/watch/namespaces/{namespace}/jobs/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/watch/namespaces/{namespace}/jobs/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
