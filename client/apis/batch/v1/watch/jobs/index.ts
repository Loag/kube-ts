...
/**
 * Builds and executes requests for operations under /apis/batch/v1/watch/jobs
 */
 ...
 */
export const JobsRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/watch/jobs{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
