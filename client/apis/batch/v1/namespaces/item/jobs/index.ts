...
// @ts-ignore
import { createJobFromDiscriminatorValue, createJobListFromDiscriminatorValue, type Job, type JobList } from '../../../../../../models/api/batch/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/batch/v1/namespaces/{namespace}/jobs
 */
export interface JobsRequestBuilder extends BaseRequestBuilder<JobsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.batch.v1.namespaces.item.jobs.item collection
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<JobsRequestBuilderDeleteQueryParameters> | undefined) : Promise<Status | undefined>;
    /**
     * list or watch objects of kind Job
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<JobList>}
     */
     get(requestConfiguration?: RequestConfiguration<JobsRequestBuilderGetQueryParameters> | undefined) : Promise<JobList | undefined>;
    /**
     * create a Job
     ...
     * @returns {Promise<Job>}
     */
     post(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<JobsRequestBuilderPostQueryParameters> | undefined) : Promise<Job | undefined>;
    /**
     * delete collection of Job
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toDeleteRequestInformation(body: DeleteOptions, requestConfiguration?: RequestConfiguration<JobsRequestBuilderDeleteQueryParameters> | undefined) : RequestInformation;
    /**
     * list or watch objects of kind Job
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<JobsRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * delete collection of Job
 */
export interface JobsRequestBuilderDeleteQueryParameters {
    /**
 ...
 * create a Job
 */
export interface JobsRequestBuilderPostQueryParameters {
    /**
     * When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     */
    dryRun?: string;
...
export const JobsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createJobListFromDiscriminatorValue,
    },
    post: {
        uriTemplate: JobsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
