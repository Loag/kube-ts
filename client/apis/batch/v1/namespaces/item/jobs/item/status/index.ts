...
/**
 * Builds and executes requests for operations under /apis/batch/v1/namespaces/{namespace}/jobs/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     * @returns {Promise<Job>}
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<Job | undefined>;
    /**
     ...
     * @returns {Promise<Job>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<Job | undefined>;
    /**
     ...
     * @returns {Promise<Job>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<Job | undefined>;
    /**
     * read status of the specified Job
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/namespaces/{namespace}/jobs/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
