...
/**
 * Builds and executes requests for operations under /apis/batch/v1/namespaces/{namespace}
 */
 ...
 */
export const WithNamespaceItemRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/namespaces/{namespace}";
/**
