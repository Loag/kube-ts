...
/**
 * Builds and executes requests for operations under /apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<CronJob | undefined>;
    /**
     ...
     * @returns {Promise<CronJob>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<CronJob | undefined>;
    /**
     ...
     * @returns {Promise<CronJob>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<CronJob | undefined>;
    /**
     * read status of the specified CronJob
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
