...
// @ts-ignore
import { createCronJobFromDiscriminatorValue, serializeCronJob, type CronJob } from '../../../../../../../models/api/batch/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/batch/v1/namespaces/{namespace}/cronjobs/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<CronJob | undefined>;
    /**
     ...
     * @returns {Promise<CronJob>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<CronJob | undefined>;
    /**
     ...
     * @returns {Promise<CronJob>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<CronJob | undefined>;
    /**
     * delete a CronJob
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
