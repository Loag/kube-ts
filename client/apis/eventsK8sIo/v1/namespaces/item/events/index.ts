...
// @ts-ignore
import { createEventFromDiscriminatorValue, createEventListFromDiscriminatorValue, type Event, type EventList } from '../../../../../../models/api/events/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/events.k8s.io/v1/namespaces/{namespace}/events
 */
export interface EventsRequestBuilder extends BaseRequestBuilder<EventsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.eventsK8sIo.v1.namespaces.item.events.item collection
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<EventsRequestBuilderDeleteQueryParameters> | undefined) : Promise<Status | undefined>;
    /**
     * list or watch objects of kind Event
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<EventList>}
     */
     get(requestConfiguration?: RequestConfiguration<EventsRequestBuilderGetQueryParameters> | undefined) : Promise<EventList | undefined>;
    /**
     * create an Event
     ...
     */
     post(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<EventsRequestBuilderPostQueryParameters> | undefined) : Promise<Event | undefined>;
    /**
     * delete collection of Event
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toDeleteRequestInformation(body: DeleteOptions, requestConfiguration?: RequestConfiguration<EventsRequestBuilderDeleteQueryParameters> | undefined) : RequestInformation;
    /**
     * list or watch objects of kind Event
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<EventsRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * delete collection of Event
 */
export interface EventsRequestBuilderDeleteQueryParameters {
    /**
...
export const EventsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createEventListFromDiscriminatorValue,
    },
    post: {
        uriTemplate: EventsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
