...
/**
 * Builds and executes requests for operations under /apis/events.k8s.io/v1/watch/namespaces
 */
export interface NamespacesRequestBuilder extends BaseRequestBuilder<NamespacesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.eventsK8sIo.v1.watch.namespaces.item collection
 ...
 */
export const NamespacesRequestBuilderUriTemplate = "{+baseurl}/apis/events.k8s.io/v1/watch/namespaces";
/**
