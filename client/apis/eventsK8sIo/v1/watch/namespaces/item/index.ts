...
/**
 * Builds and executes requests for operations under /apis/events.k8s.io/v1/watch/namespaces/{namespace}
 */
 ...
 */
export const WithNamespaceItemRequestBuilderUriTemplate = "{+baseurl}/apis/events.k8s.io/v1/watch/namespaces/{namespace}";
/**
