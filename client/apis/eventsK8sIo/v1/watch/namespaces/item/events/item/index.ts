...
/**
 * Builds and executes requests for operations under /apis/events.k8s.io/v1/watch/namespaces/{namespace}/events/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
