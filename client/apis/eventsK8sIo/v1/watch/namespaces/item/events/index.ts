...
/**
 * Builds and executes requests for operations under /apis/events.k8s.io/v1/watch/namespaces/{namespace}/events
 */
export interface EventsRequestBuilder extends BaseRequestBuilder<EventsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.eventsK8sIo.v1.watch.namespaces.item.events.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<EventsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Event. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const EventsRequestBuilderUriTemplate = "{+baseurl}/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
