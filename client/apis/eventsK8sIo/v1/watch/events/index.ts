...
/**
 * Builds and executes requests for operations under /apis/events.k8s.io/v1/watch/events
 */
 ...
 */
export const EventsRequestBuilderUriTemplate = "{+baseurl}/apis/events.k8s.io/v1/watch/events{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
