...
// @ts-ignore
import { createEndpointSliceFromDiscriminatorValue, serializeEndpointSlice, type EndpointSlice } from '../../../../../../../models/api/discovery/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<EndpointSlice | undefined>;
    /**
     ...
     * @returns {Promise<EndpointSlice>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<EndpointSlice | undefined>;
    /**
     ...
     * @returns {Promise<EndpointSlice>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<EndpointSlice | undefined>;
    /**
     * delete an EndpointSlice
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
