...
/**
 * Builds and executes requests for operations under /apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
