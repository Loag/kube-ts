 ...
 */
export const InternalApiserverK8sIoRequestBuilderNavigationMetadata: Record<Exclude<keyof InternalApiserverK8sIoRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    v1alpha1: {
 ...
 */
export const InternalApiserverK8sIoRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: InternalApiserverK8sIoRequestBuilderUriTemplate,
