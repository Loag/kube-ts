...
/**
 * Builds and executes requests for operations under /apis/internal.apiserver.k8s.io/v1alpha1/
 */
 ...
 */
export const V1alpha1RequestBuilderUriTemplate = "{+baseurl}/apis/internal.apiserver.k8s.io/v1alpha1/";
/**
