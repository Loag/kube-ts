...
/**
 * Builds and executes requests for operations under /apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
