...
/**
 * Builds and executes requests for operations under /apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<StorageVersion | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersion>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<StorageVersion | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersion>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<StorageVersion | undefined>;
    /**
     * read status of the specified StorageVersion
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
