...
// @ts-ignore
import { createStorageVersionFromDiscriminatorValue, serializeStorageVersion, type StorageVersion } from '../../../../../models/api/apiserverinternal/v1alpha1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<StorageVersion | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersion>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<StorageVersion | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersion>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<StorageVersion | undefined>;
    /**
     * delete a StorageVersion
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
