...
/**
 * Builds and executes requests for operations under /apis/flowcontrol.apiserver.k8s.io/v1/flowschemas/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<FlowSchema | undefined>;
    /**
     ...
     * @returns {Promise<FlowSchema>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<FlowSchema | undefined>;
    /**
     ...
     * @returns {Promise<FlowSchema>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<FlowSchema | undefined>;
    /**
     * read status of the specified FlowSchema
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/flowcontrol.apiserver.k8s.io/v1/flowschemas/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
