...
/**
 * Builds and executes requests for operations under /apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<PriorityLevelConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<PriorityLevelConfiguration>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<PriorityLevelConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<PriorityLevelConfiguration>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<PriorityLevelConfiguration | undefined>;
    /**
     * read status of the specified PriorityLevelConfiguration
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
