...
// @ts-ignore
import { createPriorityLevelConfigurationFromDiscriminatorValue, serializePriorityLevelConfiguration, type PriorityLevelConfiguration } from '../../../../../models/api/flowcontrol/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<PriorityLevelConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<PriorityLevelConfiguration>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<PriorityLevelConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<PriorityLevelConfiguration>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<PriorityLevelConfiguration | undefined>;
    /**
     * delete a PriorityLevelConfiguration
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/flowcontrol.apiserver.k8s.io/v1/prioritylevelconfigurations/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
