...
/**
 * Builds and executes requests for operations under /apis/flowcontrol.apiserver.k8s.io/v1/watch/flowschemas/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/flowcontrol.apiserver.k8s.io/v1/watch/flowschemas/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
