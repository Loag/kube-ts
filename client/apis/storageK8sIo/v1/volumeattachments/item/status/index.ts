...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1/volumeattachments/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<VolumeAttachment | undefined>;
    /**
     ...
     * @returns {Promise<VolumeAttachment>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<VolumeAttachment | undefined>;
    /**
     ...
     * @returns {Promise<VolumeAttachment>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<VolumeAttachment | undefined>;
    /**
     * read status of the specified VolumeAttachment
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1/volumeattachments/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
