...
// @ts-ignore
import { createCSIStorageCapacityFromDiscriminatorValue, serializeCSIStorageCapacity, type CSIStorageCapacity } from '../../../../../../../models/api/storage/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<CSIStorageCapacity | undefined>;
    /**
     ...
     * @returns {Promise<CSIStorageCapacity>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<CSIStorageCapacity | undefined>;
    /**
     ...
     * @returns {Promise<CSIStorageCapacity>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<CSIStorageCapacity | undefined>;
    /**
     * delete a CSIStorageCapacity
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
