...
// @ts-ignore
import { createCSIDriverFromDiscriminatorValue, serializeCSIDriver, type CSIDriver } from '../../../../../models/api/storage/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1/csidrivers/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderDeleteQueryParameters> | undefined) : Promise<CSIDriver | undefined>;
    /**
     * read the specified CSIDriver
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<CSIDriver>}
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<CSIDriver | undefined>;
    /**
     ...
     * @returns {Promise<CSIDriver>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<CSIDriver | undefined>;
    /**
     ...
     * @returns {Promise<CSIDriver>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<CSIDriver | undefined>;
    /**
     * delete a CSIDriver
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1/csidrivers/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
