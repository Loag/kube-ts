...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io
 */
export interface StorageK8sIoRequestBuilder extends BaseRequestBuilder<StorageK8sIoRequestBuilder> {
    /**
     * The v1 property
     */
 ...
 */
export const StorageK8sIoRequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const StorageK8sIoRequestBuilderNavigationMetadata: Record<Exclude<keyof StorageK8sIoRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    v1: {
 ...
 */
export const StorageK8sIoRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: StorageK8sIoRequestBuilderUriTemplate,
