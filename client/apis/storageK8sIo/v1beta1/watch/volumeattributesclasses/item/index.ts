...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1beta1/watch/volumeattributesclasses/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1beta1/watch/volumeattributesclasses/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
