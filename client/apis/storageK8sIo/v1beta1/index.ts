...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1beta1/
 */
 ...
 */
export const V1beta1RequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1beta1/";
/**
