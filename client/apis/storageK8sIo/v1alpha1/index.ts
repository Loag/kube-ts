...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1alpha1/
 */
 ...
 */
export const V1alpha1RequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1alpha1/";
/**
