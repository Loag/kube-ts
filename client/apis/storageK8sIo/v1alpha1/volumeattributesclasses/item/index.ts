...
// @ts-ignore
import { createVolumeAttributesClassFromDiscriminatorValue, serializeVolumeAttributesClass, type VolumeAttributesClass } from '../../../../../models/api/storage/v1alpha1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
