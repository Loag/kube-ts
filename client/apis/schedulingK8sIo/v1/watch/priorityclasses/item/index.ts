...
/**
 * Builds and executes requests for operations under /apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
