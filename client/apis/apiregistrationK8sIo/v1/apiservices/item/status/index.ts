...
/**
 * Builds and executes requests for operations under /apis/apiregistration.k8s.io/v1/apiservices/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<APIService | undefined>;
    /**
     ...
     * @returns {Promise<APIService>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<APIService | undefined>;
    /**
     ...
     * @returns {Promise<APIService>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<APIService | undefined>;
    /**
     * read status of the specified APIService
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/apiregistration.k8s.io/v1/apiservices/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
