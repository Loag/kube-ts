...
/**
 * Builds and executes requests for operations under /apis/apiregistration.k8s.io/v1/
 */
 ...
 */
export const V1RequestBuilderUriTemplate = "{+baseurl}/apis/apiregistration.k8s.io/v1/";
/**
