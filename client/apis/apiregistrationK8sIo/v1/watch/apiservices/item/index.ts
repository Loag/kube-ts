...
/**
 * Builds and executes requests for operations under /apis/apiregistration.k8s.io/v1/watch/apiservices/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
