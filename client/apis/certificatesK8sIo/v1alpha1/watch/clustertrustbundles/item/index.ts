...
/**
 * Builds and executes requests for operations under /apis/certificates.k8s.io/v1alpha1/watch/clustertrustbundles/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/certificates.k8s.io/v1alpha1/watch/clustertrustbundles/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
