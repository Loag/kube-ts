...
// @ts-ignore
import { createClusterTrustBundleFromDiscriminatorValue, serializeClusterTrustBundle, type ClusterTrustBundle } from '../../../../../models/api/certificates/v1alpha1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ClusterTrustBundle | undefined>;
    /**
     ...
     * @returns {Promise<ClusterTrustBundle>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ClusterTrustBundle | undefined>;
    /**
     ...
     * @returns {Promise<ClusterTrustBundle>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ClusterTrustBundle | undefined>;
    /**
     * delete a ClusterTrustBundle
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
