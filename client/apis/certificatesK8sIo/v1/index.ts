...
/**
 * Builds and executes requests for operations under /apis/certificates.k8s.io/v1/
 */
 ...
 */
export const V1RequestBuilderUriTemplate = "{+baseurl}/apis/certificates.k8s.io/v1/";
/**
