...
/**
 * Builds and executes requests for operations under /apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<CertificateSigningRequest | undefined>;
    /**
     ...
     * @returns {Promise<CertificateSigningRequest>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<CertificateSigningRequest | undefined>;
    /**
     ...
     * @returns {Promise<CertificateSigningRequest>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<CertificateSigningRequest | undefined>;
    /**
     * read status of the specified CertificateSigningRequest
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
