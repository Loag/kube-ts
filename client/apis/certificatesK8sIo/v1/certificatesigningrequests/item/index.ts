...
// @ts-ignore
import { ApprovalRequestBuilderRequestsMetadata, type ApprovalRequestBuilder } from './approval/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/certificates.k8s.io/v1/certificatesigningrequests/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<CertificateSigningRequest | undefined>;
    /**
     ...
     * @returns {Promise<CertificateSigningRequest>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<CertificateSigningRequest | undefined>;
    /**
     ...
     * @returns {Promise<CertificateSigningRequest>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<CertificateSigningRequest | undefined>;
    /**
     * delete a CertificateSigningRequest
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
