...
/**
 * Builds and executes requests for operations under /apis/certificates.k8s.io/v1/watch/certificatesigningrequests/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/certificates.k8s.io/v1/watch/certificatesigningrequests/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
