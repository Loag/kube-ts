...
/**
 * Builds and executes requests for operations under /apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<PodDisruptionBudget | undefined>;
    /**
     ...
     * @returns {Promise<PodDisruptionBudget>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<PodDisruptionBudget | undefined>;
    /**
     ...
     * @returns {Promise<PodDisruptionBudget>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<PodDisruptionBudget | undefined>;
    /**
     * read status of the specified PodDisruptionBudget
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
