...
// @ts-ignore
import { createPodDisruptionBudgetFromDiscriminatorValue, serializePodDisruptionBudget, type PodDisruptionBudget } from '../../../../../../../models/api/policy/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<PodDisruptionBudget | undefined>;
    /**
     ...
     * @returns {Promise<PodDisruptionBudget>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<PodDisruptionBudget | undefined>;
    /**
     ...
     * @returns {Promise<PodDisruptionBudget>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<PodDisruptionBudget | undefined>;
    /**
     * delete a PodDisruptionBudget
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
