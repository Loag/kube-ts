...
/**
 * Builds and executes requests for operations under /apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
