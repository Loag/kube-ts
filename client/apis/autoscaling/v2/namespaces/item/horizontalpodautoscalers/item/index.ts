...
// @ts-ignore
import { createHorizontalPodAutoscalerFromDiscriminatorValue, serializeHorizontalPodAutoscaler, type HorizontalPodAutoscaler } from '../../../../../../../models/api/autoscaling/v2/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<HorizontalPodAutoscaler | undefined>;
    /**
     ...
     * @returns {Promise<HorizontalPodAutoscaler>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<HorizontalPodAutoscaler | undefined>;
    /**
     ...
     * @returns {Promise<HorizontalPodAutoscaler>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<HorizontalPodAutoscaler | undefined>;
    /**
     * delete a HorizontalPodAutoscaler
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
