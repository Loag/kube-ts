...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status
 */
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
