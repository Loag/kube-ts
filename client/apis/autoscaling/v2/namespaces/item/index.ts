...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v2/namespaces/{namespace}
 */
 ...
 */
export const WithNamespaceItemRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v2/namespaces/{namespace}";
/**
