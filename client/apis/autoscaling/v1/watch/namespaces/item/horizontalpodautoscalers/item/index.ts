...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
