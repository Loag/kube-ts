...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v1/namespaces/{namespace}
 */
 ...
 */
export const WithNamespaceItemRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v1/namespaces/{namespace}";
/**
