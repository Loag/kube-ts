...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<HorizontalPodAutoscaler | undefined>;
    /**
     ...
     * @returns {Promise<HorizontalPodAutoscaler>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<HorizontalPodAutoscaler | undefined>;
    /**
     ...
     * @returns {Promise<HorizontalPodAutoscaler>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<HorizontalPodAutoscaler | undefined>;
    /**
     * read status of the specified HorizontalPodAutoscaler
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
