...
// @ts-ignore
import { createHorizontalPodAutoscalerFromDiscriminatorValue, serializeHorizontalPodAutoscaler, type HorizontalPodAutoscaler } from '../../../../../../../models/api/autoscaling/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
