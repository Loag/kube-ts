...
/**
 * Builds and executes requests for operations under /apis/autoscaling/v1/namespaces
 */
export interface NamespacesRequestBuilder extends BaseRequestBuilder<NamespacesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.autoscaling.v1.namespaces.item collection
 ...
 */
export const NamespacesRequestBuilderUriTemplate = "{+baseurl}/apis/autoscaling/v1/namespaces";
/**
