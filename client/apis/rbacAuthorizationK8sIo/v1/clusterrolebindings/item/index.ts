...
// @ts-ignore
import { createClusterRoleBindingFromDiscriminatorValue, serializeClusterRoleBinding, type ClusterRoleBinding } from '../../../../../models/api/rbac/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ClusterRoleBinding | undefined>;
    /**
     ...
     * @returns {Promise<ClusterRoleBinding>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ClusterRoleBinding | undefined>;
    /**
     ...
     * @returns {Promise<ClusterRoleBinding>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ClusterRoleBinding | undefined>;
    /**
     * delete a ClusterRoleBinding
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
