...
// @ts-ignore
import { createRoleBindingFromDiscriminatorValue, serializeRoleBinding, type RoleBinding } from '../../../../../../../models/api/rbac/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<RoleBinding | undefined>;
    /**
     ...
     * @returns {Promise<RoleBinding>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<RoleBinding | undefined>;
    /**
     ...
     * @returns {Promise<RoleBinding>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<RoleBinding | undefined>;
    /**
     * delete a RoleBinding
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
