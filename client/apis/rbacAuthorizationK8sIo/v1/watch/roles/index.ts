...
/**
 * Builds and executes requests for operations under /apis/rbac.authorization.k8s.io/v1/watch/roles
 */
 ...
 */
export const RolesRequestBuilderUriTemplate = "{+baseurl}/apis/rbac.authorization.k8s.io/v1/watch/roles{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
