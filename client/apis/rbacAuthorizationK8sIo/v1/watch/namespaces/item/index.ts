...
/**
 * Builds and executes requests for operations under /apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}
 */
 ...
 */
export const WithNamespaceItemRequestBuilderUriTemplate = "{+baseurl}/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}";
/**
