...
/**
 * Builds and executes requests for operations under /apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles
 */
export interface RolesRequestBuilder extends BaseRequestBuilder<RolesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.rbacAuthorizationK8sIo.v1.watch.namespaces.item.roles.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<RolesRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Role. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const RolesRequestBuilderUriTemplate = "{+baseurl}/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
