...
// @ts-ignore
import { createControllerRevisionListFromDiscriminatorValue, type ControllerRevisionList } from '../../../../models/api/apps/v1/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /apis/apps/v1/controllerrevisions
 */
 ...
 */
export const ControllerrevisionsRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/controllerrevisions{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
