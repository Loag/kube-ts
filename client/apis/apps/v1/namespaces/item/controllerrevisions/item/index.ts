...
// @ts-ignore
import { createControllerRevisionFromDiscriminatorValue, serializeControllerRevision, type ControllerRevision } from '../../../../../../../models/api/apps/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ControllerRevision | undefined>;
    /**
     ...
     * @returns {Promise<ControllerRevision>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ControllerRevision | undefined>;
    /**
     ...
     * @returns {Promise<ControllerRevision>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ControllerRevision | undefined>;
    /**
     * delete a ControllerRevision
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
