...
/**
 * Builds and executes requests for operations under /apis/apps/v1/namespaces/{namespace}/deployments/{name}/scale
 */
 ...
 */
export const ScaleRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/namespaces/{namespace}/deployments/{name}/scale{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
