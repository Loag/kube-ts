...
// @ts-ignore
import { createDeploymentFromDiscriminatorValue, createDeploymentListFromDiscriminatorValue, type Deployment, type DeploymentList } from '../../../../../../models/api/apps/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/apps/v1/namespaces/{namespace}/deployments
 */
export interface DeploymentsRequestBuilder extends BaseRequestBuilder<DeploymentsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.apps.v1.namespaces.item.deployments.item collection
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<DeploymentsRequestBuilderDeleteQueryParameters> | undefined) : Promise<Status | undefined>;
    /**
     * list or watch objects of kind Deployment
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<DeploymentList>}
     */
     get(requestConfiguration?: RequestConfiguration<DeploymentsRequestBuilderGetQueryParameters> | undefined) : Promise<DeploymentList | undefined>;
    /**
     * create a Deployment
     ...
     */
     post(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<DeploymentsRequestBuilderPostQueryParameters> | undefined) : Promise<Deployment | undefined>;
    /**
     * delete collection of Deployment
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toDeleteRequestInformation(body: DeleteOptions, requestConfiguration?: RequestConfiguration<DeploymentsRequestBuilderDeleteQueryParameters> | undefined) : RequestInformation;
    /**
     * list or watch objects of kind Deployment
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<DeploymentsRequestBuilderPostQueryParameters> | undefined) : RequestInformation;
}
/**
 * delete collection of Deployment
 */
export interface DeploymentsRequestBuilderDeleteQueryParameters {
    /**
 ...
 * create a Deployment
 */
export interface DeploymentsRequestBuilderPostQueryParameters {
    /**
     * When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
     */
    dryRun?: string;
...
export const DeploymentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        adapterMethodName: "send",
        responseBodyFactory:  createDeploymentListFromDiscriminatorValue,
    },
    post: {
        uriTemplate: DeploymentsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
