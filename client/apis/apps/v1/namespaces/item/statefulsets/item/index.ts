...
// @ts-ignore
import { createStatefulSetFromDiscriminatorValue, serializeStatefulSet, type StatefulSet } from '../../../../../../../models/api/apps/v1/index.js';
// @ts-ignore
...
// @ts-ignore
import { ScaleRequestBuilderRequestsMetadata, type ScaleRequestBuilder } from './scale/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/apps/v1/namespaces/{namespace}/statefulsets/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
    /**
     * The scale property
     */
    get scale(): ScaleRequestBuilder;
    /**
     * The status property
     */
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<StatefulSet | undefined>;
    /**
     ...
     * @returns {Promise<StatefulSet>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<StatefulSet | undefined>;
    /**
     ...
     * @returns {Promise<StatefulSet>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<StatefulSet | undefined>;
    /**
     * delete a StatefulSet
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
...
export const WithNameItemRequestBuilderNavigationMetadata: Record<Exclude<keyof WithNameItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    scale: {
        requestsMetadata: ScaleRequestBuilderRequestsMetadata,
    },
    status: {
