...
/**
 * Builds and executes requests for operations under /apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/scale
 */
 ...
 */
export const ScaleRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/scale{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
