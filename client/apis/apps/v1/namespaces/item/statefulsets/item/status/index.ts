...
/**
 * Builds and executes requests for operations under /apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<StatefulSet | undefined>;
    /**
     ...
     * @returns {Promise<StatefulSet>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<StatefulSet | undefined>;
    /**
     ...
     * @returns {Promise<StatefulSet>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<StatefulSet | undefined>;
    /**
     * read status of the specified StatefulSet
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
