...
/**
 * Builds and executes requests for operations under /apis/apps/v1/watch/controllerrevisions
 */
 ...
 */
export const ControllerrevisionsRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/watch/controllerrevisions{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
