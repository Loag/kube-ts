...
/**
 * Builds and executes requests for operations under /apis/apps/v1/watch/namespaces
 */
export interface NamespacesRequestBuilder extends BaseRequestBuilder<NamespacesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.apps.v1.watch.namespaces.item collection
 ...
 */
export const NamespacesRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/watch/namespaces";
/**
