...
/**
 * Builds and executes requests for operations under /apis/apps/v1/watch/namespaces/{namespace}/controllerrevisions
 */
export interface ControllerrevisionsRequestBuilder extends BaseRequestBuilder<ControllerrevisionsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.apps.v1.watch.namespaces.item.controllerrevisions.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ControllerrevisionsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of ControllerRevision. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ControllerrevisionsRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/watch/namespaces/{namespace}/controllerrevisions{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
