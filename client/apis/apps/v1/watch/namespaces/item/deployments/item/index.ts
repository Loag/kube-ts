...
/**
 * Builds and executes requests for operations under /apis/apps/v1/watch/namespaces/{namespace}/deployments/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/watch/namespaces/{namespace}/deployments/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
