...
/**
 * Builds and executes requests for operations under /apis/apps/v1/watch/namespaces/{namespace}/deployments
 */
export interface DeploymentsRequestBuilder extends BaseRequestBuilder<DeploymentsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.apps.v1.watch.namespaces.item.deployments.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<DeploymentsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of Deployment. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const DeploymentsRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/watch/namespaces/{namespace}/deployments{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
