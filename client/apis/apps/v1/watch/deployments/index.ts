...
/**
 * Builds and executes requests for operations under /apis/apps/v1/watch/deployments
 */
 ...
 */
export const DeploymentsRequestBuilderUriTemplate = "{+baseurl}/apis/apps/v1/watch/deployments{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
