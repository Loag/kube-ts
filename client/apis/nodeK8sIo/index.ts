...
/**
 * Builds and executes requests for operations under /apis/node.k8s.io
 */
export interface NodeK8sIoRequestBuilder extends BaseRequestBuilder<NodeK8sIoRequestBuilder> {
    /**
     * The v1 property
     */
 ...
 */
export const NodeK8sIoRequestBuilderUriTemplate = "{+baseurl}/apis/node.k8s.io";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const NodeK8sIoRequestBuilderNavigationMetadata: Record<Exclude<keyof NodeK8sIoRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    v1: {
 ...
 */
export const NodeK8sIoRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: NodeK8sIoRequestBuilderUriTemplate,
