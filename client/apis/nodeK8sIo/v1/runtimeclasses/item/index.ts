...
// @ts-ignore
import { createRuntimeClassFromDiscriminatorValue, serializeRuntimeClass, type RuntimeClass } from '../../../../../models/api/node/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/node.k8s.io/v1/runtimeclasses/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<RuntimeClass | undefined>;
    /**
     ...
     * @returns {Promise<RuntimeClass>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<RuntimeClass | undefined>;
    /**
     ...
     * @returns {Promise<RuntimeClass>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<RuntimeClass | undefined>;
    /**
     * delete a RuntimeClass
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/node.k8s.io/v1/runtimeclasses/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
