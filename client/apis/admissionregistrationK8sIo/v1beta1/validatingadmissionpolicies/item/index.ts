...
// @ts-ignore
import { createValidatingAdmissionPolicyFromDiscriminatorValue, serializeValidatingAdmissionPolicy, type ValidatingAdmissionPolicy } from '../../../../../models/api/admissionregistration/v1beta1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ValidatingAdmissionPolicy | undefined>;
    /**
     ...
     * @returns {Promise<ValidatingAdmissionPolicy>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ValidatingAdmissionPolicy | undefined>;
    /**
     ...
     * @returns {Promise<ValidatingAdmissionPolicy>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ValidatingAdmissionPolicy | undefined>;
    /**
     * delete a ValidatingAdmissionPolicy
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
