...
// @ts-ignore
import { createValidatingWebhookConfigurationFromDiscriminatorValue, serializeValidatingWebhookConfiguration, type ValidatingWebhookConfiguration } from '../../../../../models/api/admissionregistration/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ValidatingWebhookConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<ValidatingWebhookConfiguration>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ValidatingWebhookConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<ValidatingWebhookConfiguration>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ValidatingWebhookConfiguration | undefined>;
    /**
     * delete a ValidatingWebhookConfiguration
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
