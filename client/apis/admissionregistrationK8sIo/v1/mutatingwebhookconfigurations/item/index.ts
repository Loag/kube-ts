...
// @ts-ignore
import { createMutatingWebhookConfigurationFromDiscriminatorValue, serializeMutatingWebhookConfiguration, type MutatingWebhookConfiguration } from '../../../../../models/api/admissionregistration/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<MutatingWebhookConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<MutatingWebhookConfiguration>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<MutatingWebhookConfiguration | undefined>;
    /**
     ...
     * @returns {Promise<MutatingWebhookConfiguration>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<MutatingWebhookConfiguration | undefined>;
    /**
     * delete a MutatingWebhookConfiguration
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
