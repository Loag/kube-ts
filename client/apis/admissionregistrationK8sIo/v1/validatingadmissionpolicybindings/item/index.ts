...
// @ts-ignore
import { createValidatingAdmissionPolicyBindingFromDiscriminatorValue, serializeValidatingAdmissionPolicyBinding, type ValidatingAdmissionPolicyBinding } from '../../../../../models/api/admissionregistration/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1/validatingadmissionpolicybindings/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicybindings/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
