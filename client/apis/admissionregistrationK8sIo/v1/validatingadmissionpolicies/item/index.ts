...
// @ts-ignore
import { createValidatingAdmissionPolicyFromDiscriminatorValue, serializeValidatingAdmissionPolicy, type ValidatingAdmissionPolicy } from '../../../../../models/api/admissionregistration/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
