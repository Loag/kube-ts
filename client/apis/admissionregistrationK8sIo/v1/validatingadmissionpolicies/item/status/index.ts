...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}/status
 */
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
