...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1/watch/validatingadmissionpolicies/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1/watch/validatingadmissionpolicies/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
