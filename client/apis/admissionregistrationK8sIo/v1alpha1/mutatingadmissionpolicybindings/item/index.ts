...
// @ts-ignore
import { createMutatingAdmissionPolicyBindingFromDiscriminatorValue, serializeMutatingAdmissionPolicyBinding, type MutatingAdmissionPolicyBinding } from '../../../../../models/api/admissionregistration/v1alpha1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicybindings/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<MutatingAdmissionPolicyBinding | undefined>;
    /**
     ...
     * @returns {Promise<MutatingAdmissionPolicyBinding>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<MutatingAdmissionPolicyBinding | undefined>;
    /**
     ...
     * @returns {Promise<MutatingAdmissionPolicyBinding>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<MutatingAdmissionPolicyBinding | undefined>;
    /**
     * delete a MutatingAdmissionPolicyBinding
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicybindings/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
