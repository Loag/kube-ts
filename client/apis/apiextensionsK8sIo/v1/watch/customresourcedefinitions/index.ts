...
/**
 * Builds and executes requests for operations under /apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions
 */
export interface CustomresourcedefinitionsRequestBuilder extends BaseRequestBuilder<CustomresourcedefinitionsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.apiextensionsK8sIo.v1.watch.customresourcedefinitions.item collection
     ...
     */
     get(requestConfiguration?: RequestConfiguration<CustomresourcedefinitionsRequestBuilderGetQueryParameters> | undefined) : Promise<WatchEvent | undefined>;
    /**
     * watch individual changes to a list of CustomResourceDefinition. deprecated: use the 'watch' parameter with a list operation instead.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const CustomresourcedefinitionsRequestBuilderUriTemplate = "{+baseurl}/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
