...
/**
 * Builds and executes requests for operations under /apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
