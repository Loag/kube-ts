...
/**
 * Builds and executes requests for operations under /apis/apiextensions.k8s.io/v1/
 */
 ...
 */
export const V1RequestBuilderUriTemplate = "{+baseurl}/apis/apiextensions.k8s.io/v1/";
/**
