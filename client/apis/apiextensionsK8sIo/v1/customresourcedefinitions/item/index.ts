...
// @ts-ignore
import { createCustomResourceDefinitionFromDiscriminatorValue, serializeCustomResourceDefinition, type CustomResourceDefinition } from '../../../../../models/apiextensionsApiserver/pkg/apis/apiextensions/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<CustomResourceDefinition | undefined>;
    /**
     ...
     * @returns {Promise<CustomResourceDefinition>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<CustomResourceDefinition | undefined>;
    /**
     ...
     * @returns {Promise<CustomResourceDefinition>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<CustomResourceDefinition | undefined>;
    /**
     * delete a CustomResourceDefinition
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
