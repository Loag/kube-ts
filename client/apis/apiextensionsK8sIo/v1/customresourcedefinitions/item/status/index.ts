...
/**
 * Builds and executes requests for operations under /apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<CustomResourceDefinition | undefined>;
    /**
     ...
     * @returns {Promise<CustomResourceDefinition>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<CustomResourceDefinition | undefined>;
    /**
     ...
     * @returns {Promise<CustomResourceDefinition>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<CustomResourceDefinition | undefined>;
    /**
     * read status of the specified CustomResourceDefinition
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
