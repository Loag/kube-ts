...
// @ts-ignore
import { createLeaseCandidateFromDiscriminatorValue, serializeLeaseCandidate, type LeaseCandidate } from '../../../../../../../models/api/coordination/v1alpha2/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/coordination.k8s.io/v1alpha2/namespaces/{namespace}/leasecandidates/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<LeaseCandidate | undefined>;
    /**
     ...
     * @returns {Promise<LeaseCandidate>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<LeaseCandidate | undefined>;
    /**
     ...
     * @returns {Promise<LeaseCandidate>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<LeaseCandidate | undefined>;
    /**
     * delete a LeaseCandidate
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/coordination.k8s.io/v1alpha2/namespaces/{namespace}/leasecandidates/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
