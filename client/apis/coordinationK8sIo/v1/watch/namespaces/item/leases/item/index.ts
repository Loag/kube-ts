...
/**
 * Builds and executes requests for operations under /apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
