...
// @ts-ignore
import { LeasesRequestBuilderRequestsMetadata, type LeasesRequestBuilder } from './leases/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/coordination.k8s.io/v1/watch
 */
 ...
 */
export const WatchRequestBuilderUriTemplate = "{+baseurl}/apis/coordination.k8s.io/v1/watch";
/**
