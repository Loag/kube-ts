...
/**
 * Builds and executes requests for operations under /apis/coordination.k8s.io/v1/
 */
 ...
 */
export const V1RequestBuilderUriTemplate = "{+baseurl}/apis/coordination.k8s.io/v1/";
/**
