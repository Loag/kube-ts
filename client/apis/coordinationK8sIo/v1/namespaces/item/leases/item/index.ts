...
// @ts-ignore
import { createLeaseFromDiscriminatorValue, serializeLease, type Lease } from '../../../../../../../models/api/coordination/v1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<Lease | undefined>;
    /**
     ...
     * @returns {Promise<Lease>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<Lease | undefined>;
    /**
     ...
     * @returns {Promise<Lease>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<Lease | undefined>;
    /**
     * delete a Lease
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
