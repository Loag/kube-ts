...
/**
 * Builds and executes requests for operations under /apis/coordination.k8s.io/v1/namespaces
 */
export interface NamespacesRequestBuilder extends BaseRequestBuilder<NamespacesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.coordinationK8sIo.v1.namespaces.item collection
 ...
 */
export const NamespacesRequestBuilderUriTemplate = "{+baseurl}/apis/coordination.k8s.io/v1/namespaces";
/**
