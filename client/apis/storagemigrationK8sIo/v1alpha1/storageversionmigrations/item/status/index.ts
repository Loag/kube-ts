...
/**
 * Builds and executes requests for operations under /apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status
 */
export interface StatusRequestBuilder extends BaseRequestBuilder<StatusRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<StatusRequestBuilderGetQueryParameters> | undefined) : Promise<StorageVersionMigration | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersionMigration>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPatchQueryParameters> | undefined) : Promise<StorageVersionMigration | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersionMigration>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<StatusRequestBuilderPutQueryParameters> | undefined) : Promise<StorageVersionMigration | undefined>;
    /**
     * read status of the specified StorageVersionMigration
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
