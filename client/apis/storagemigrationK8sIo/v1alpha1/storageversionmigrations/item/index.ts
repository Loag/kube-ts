...
// @ts-ignore
import { createStorageVersionMigrationFromDiscriminatorValue, serializeStorageVersionMigration, type StorageVersionMigration } from '../../../../../models/api/storagemigration/v1alpha1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<StorageVersionMigration | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersionMigration>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<StorageVersionMigration | undefined>;
    /**
     ...
     * @returns {Promise<StorageVersionMigration>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<StorageVersionMigration | undefined>;
    /**
     * delete a StorageVersionMigration
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
