...
/**
 * Builds and executes requests for operations under /apis/storagemigration.k8s.io/v1alpha1/watch/storageversionmigrations/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/storagemigration.k8s.io/v1alpha1/watch/storageversionmigrations/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
