...
// @ts-ignore
import { createResourceClaimFromDiscriminatorValue, serializeResourceClaim, type ResourceClaim } from '../../../../../../../models/api/resource/v1alpha3/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderDeleteQueryParameters> | undefined) : Promise<ResourceClaim | undefined>;
    /**
     * read the specified ResourceClaim
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<ResourceClaim>}
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<ResourceClaim | undefined>;
    /**
     ...
     * @returns {Promise<ResourceClaim>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<ResourceClaim | undefined>;
    /**
     ...
     * @returns {Promise<ResourceClaim>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<ResourceClaim | undefined>;
    /**
     * delete a ResourceClaim
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
