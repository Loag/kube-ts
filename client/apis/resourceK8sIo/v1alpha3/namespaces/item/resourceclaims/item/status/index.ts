...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}/status
 */
 ...
 */
export const StatusRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}/status{?dryRun*,fieldManager*,fieldValidation*,force*,pretty*}";
/**
