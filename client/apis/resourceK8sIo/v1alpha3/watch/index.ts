...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1alpha3/watch
 */
 ...
 */
export const WatchRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1alpha3/watch";
/**
