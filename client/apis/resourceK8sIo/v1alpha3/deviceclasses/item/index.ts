...
// @ts-ignore
import { createDeviceClassFromDiscriminatorValue, serializeDeviceClass, type DeviceClass } from '../../../../../models/api/resource/v1alpha3/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1alpha3/deviceclasses/{name}
 */
export interface WithNameItemRequestBuilder extends BaseRequestBuilder<WithNameItemRequestBuilder> {
     ...
     */
     delete(body: DeleteOptions, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderDeleteQueryParameters> | undefined) : Promise<DeviceClass | undefined>;
    /**
     * read the specified DeviceClass
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<DeviceClass>}
     */
     get(requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceClass | undefined>;
    /**
     ...
     * @returns {Promise<DeviceClass>}
     */
     patch(body: Patch, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPatchQueryParameters> | undefined) : Promise<DeviceClass | undefined>;
    /**
     ...
     * @returns {Promise<DeviceClass>}
     */
     put(body: ArrayBuffer | undefined, contentType: string | undefined, requestConfiguration?: RequestConfiguration<WithNameItemRequestBuilderPutQueryParameters> | undefined) : Promise<DeviceClass | undefined>;
    /**
     * delete a DeviceClass
     * @param body DeleteOptions may be provided when deleting an API object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1alpha3/deviceclasses/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
