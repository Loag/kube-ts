...
// @ts-ignore
import { createResourceSliceFromDiscriminatorValue, serializeResourceSlice, type ResourceSlice } from '../../../../../models/api/resource/v1beta1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1beta1/resourceslices/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1beta1/resourceslices/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
