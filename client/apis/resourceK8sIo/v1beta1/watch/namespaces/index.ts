...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1beta1/watch/namespaces
 */
export interface NamespacesRequestBuilder extends BaseRequestBuilder<NamespacesRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.apis.resourceK8sIo.v1beta1.watch.namespaces.item collection
 ...
 */
export const NamespacesRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1beta1/watch/namespaces";
/**
