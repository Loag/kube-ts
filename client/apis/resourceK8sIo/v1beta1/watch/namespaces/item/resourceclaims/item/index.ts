...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1beta1/watch/namespaces/{namespace}/resourceclaims/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1beta1/watch/namespaces/{namespace}/resourceclaims/{name}{?allowWatchBookmarks*,continue*,fieldSelector*,labelSelector*,limit*,pretty*,resourceVersion*,resourceVersionMatch*,sendInitialEvents*,timeoutSeconds*,watch*}";
/**
