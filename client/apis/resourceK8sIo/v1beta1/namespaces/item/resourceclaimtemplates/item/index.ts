...
// @ts-ignore
import { createResourceClaimTemplateFromDiscriminatorValue, serializeResourceClaimTemplate, type ResourceClaimTemplate } from '../../../../../../../models/api/resource/v1beta1/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /apis/resource.k8s.io/v1beta1/namespaces/{namespace}/resourceclaimtemplates/{name}
 */
 ...
 */
export const WithNameItemRequestBuilderUriTemplate = "{+baseurl}/apis/resource.k8s.io/v1beta1/namespaces/{namespace}/resourceclaimtemplates/{name}{?dryRun*,fieldManager*,fieldValidation*,force*,gracePeriodSeconds*,ignoreStoreReadErrorWithClusterBreakingPotential*,orphanDependents*,pretty*,propagationPolicy*}";
/**
